...
MEASUREMENTS: tuple[Measurement, ...] = (
    ...
    Measurement("weight_kg", "Вес", "кг", "Вес в кг?", 30, 250),
    Measurement(
        "shoulders_cm",
        "Ширина плеч",
        "см",
        "Ширина плеч в см — по спине от плеча до плеча, это не обхват.",
        25,
        70,
    ),
    Measurement(
        ...
        "Обхват груди",
        "см",
        "Обхват груди в см — лентой вокруг по самой широкой точке.\n"
        "Если меришь вещь по плоскости, пришли полуобхват так: «пол 48».",
        60,
        160,
        girth=True,
    ),
    Measurement(
        ...
        "Обхват талии",
        "см",
        "Обхват талии в см — вокруг, по самому узкому месту.\n"
        "Полуобхват — «пол 38».",
        50,
        150,
        girth=True,
    ...
    Measurement(
        ...
        "Обхват пояса",
        "см",
        "Обхват пояса в см — там, где сидят джинсы.\n"
        "Полуобхват — «пол 42.5».",
        50,
        160,
        girth=True,
